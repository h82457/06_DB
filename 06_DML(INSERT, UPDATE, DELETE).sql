...
--INSERT INTO EMPLOYEE2 VALUES(14컬럼값 순서대로 작성);
...
VALUES ('장채현', 900, '901123-2345678', 'jang_ch@kh.or.kr', '01012341234', 'D1', 'J7', 'S3', 4300000); // 작성한 컬럼 순서대로 값 작성
...
-- * 조건절(WHERE)을 설정하지 않고 UPDATE 구문 실행 시 모든 행의 컬럼 값 변경.
UPDATE DEPARTMENT2
SET DEPT_TITLE = '인사팀';
...
-- 삭제 확인
SELECT * FROM EMPLOYEE2 WHERE EMP_NAME = '장채현'; -- 결과 없음
